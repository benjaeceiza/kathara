...
const PortafolioSchema = new mongoose_1.Schema({
    peluquero: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Usuario', required: true },
...
exports.default = mongoose_1.default.model('Portafolio', PortafolioSchema);
